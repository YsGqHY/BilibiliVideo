 ...
 */
@RuntimeDependencies(
    RuntimeDependency(value = "!com.squareup.okio:okio:1.17.2"),
    RuntimeDependency(value = "!com.squareup.okhttp3:okhttp:3.14.9"),
    RuntimeDependency(value = "!com.squareup.retrofit2:retrofit:2.9.0", relocate = ["!retrofit2", "!online.bingzi.bilibili.video.library.retrofit2"]),
    RuntimeDependency(value = "!com.squareup.retrofit2:converter-gson:2.9.0", relocate = ["!retrofit2", "!online.bingzi.bilibili.video.library.retrofit2"]),
)
object Network {
    /**
     * Passport Base Url
